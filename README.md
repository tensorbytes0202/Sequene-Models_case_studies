...
.
├── README.md
├── Question_Answering_using_BERT_(SQuAD_Dataset)_(1).ipynb
├── Sentiment_Classification_on_IMDB_Reviews_using_LSTM.ipynb
│
└── screenshots/
    ├── bert_training_progress.png.png
    ├── bert_loss_curve.png.png
    ├── bert_token_distribution.png.png
    ├── bert_train_vs_validation.png.png
    ├── lstm_training_logs.png.png
    ├── lstm_loss_graph.png.png
    └── lstm_accuracy_graph.png.png
```
...
<p align="center">
  <img src="screenshots/bert_training_progress.png.png" width="900"/>
</p>
...
<p align="center">
  <img src="screenshots/bert_loss_curve.png.png" width="800"/>
</p>
...
<p align="center">
  <img src="screenshots/bert_token_distribution.png.png" width="800"/>
</p>

### 📈 Observation

- Most contexts lie between 120–250 tokens
- Helps in selecting max sequence length
...
<p align="center">
  <img src="screenshots/bert_train_vs_validation.png.png" width="700"/>
</p>
...
<p align="center">
  <img src="screenshots/lstm_training_logs.png.png" width="850"/>
</p>
...
<p align="center">
  <img src="screenshots/lstm_loss_graph.png.png" width="700"/>
</p>
...
<p align="center">
  <img src="screenshots/lstm_accuracy_graph.png.png" width="700"/>
</p>
...
```bash
git clone https://github.com/tensorbytes0202/Sequene-Models_case_studies.git
cd Sequene-Models_case_studies
```
...
```bash
jupyter notebook "Question_Answering_using_BERT_(SQuAD_Dataset)_(1).ipynb"
```

### ▶️ LSTM Sentiment Analysis
